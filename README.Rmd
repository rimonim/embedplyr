...
To quantify how good and how intense these texts are, we can compare them to the embeddings for "good" and "intense" using `get_similarities()`. Note that this step requires only a dataframe or tibble with numeric columns; the embeddings can come from any source.
