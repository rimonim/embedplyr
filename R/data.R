...
#' Pennington et al. (2014) on 2B Tweets. This subset includes only embeddings for
#' the 14,000 most common English words, as defined by [Peter Norvig's compilation](https://norvig.com/ngrams/count_1w.txt),
...
#' @keywords data glove_twitter_25d
"glove_twitter_25d"
